 ...
 * 
 * Adapted from https://create.arduino.cc/projecthub/mircemk/diy-super-simple-electronic-component-tester-234752
 * based on code of Karl-Heinz Kubbeler (version 1.08k)
 * 
 */
...
// #define SCREEN_HEIGHT 64 // OLED display height, in pixels //PORTED
